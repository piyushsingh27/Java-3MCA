...
{   
 ...
 // private boolean issueStatus;
   ...
   do
    ...
    abstract public void display(int issueeId,String name,Issueee i);
...
class Issuee extends Books
{
    ...
    public void display(int issueeId,String name,Issueee i)
    {
        this.issueeId = issueeId;//ambiguity
        issueeName = name;
        this.i = i;
...
class Transaction extends Issuee
{
   private static String issueDate,expiryDate;
    ...
    /*          case 3:
                {
                    ...
                    if( j == 0)
                    {
                        System.out.println("Currently All The Books Are Issued");
                    }
                ...
                case 4:
                {
                    ...
                    System.out.println("Do You Want to search between a price range if yes press (y) else press (n)");
                    check = in.next().charAt(0);
                    if( check == 'y')
                    {
                        for (byte i = 0;i< no;i++)
                        {
                            j = bk[i].search(minAmt,maxAmt);
                        }
                        if( j == 0)
                        {
                            System.out.println("******************************************************************");
